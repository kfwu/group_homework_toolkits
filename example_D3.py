...
(e,d,f,a,b,c) = (0,1,2,3,4,5) # converting table into number, Identity must be 0
...
table = ([[e,d,f,a,b,c],
          ...
          [a,b,c,e,d,f],
          [b,c,a,f,e,d],
          [c,a,b,d,f,e]]) # input your multiplication table
...
for i in range(element_lens):
    ...
    invers_e = find_inverse(table,e_symbol)
...
for i in range(element_lens):
    ...
    class_e = findclass(table,e_symbol)
    invers_e = find_inverse(table,e_symbol)
    print('the invers of element '+e_symbol+' is ' + str(invers_e)) 
